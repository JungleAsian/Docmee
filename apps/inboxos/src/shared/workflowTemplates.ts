  ...
  },
  {
    ...
    nodes: [
      ...
      n('service_menu', 'action', 'action.interactive_menu', {
        ...
        doctorIdField: 'doctor_id', selectionField: 'service_id',
      }, 1240, 160),
      n('wait_service', 'logic', 'logic.wait_for_reply', { timeoutMinutes: '1440' }, 1480, 160),
      n('slots_1', 'action', 'action.available_slots', {
        doctorIdField: 'doctor_id', serviceIdField: 'service_id', timezoneField: 'clinic_timezone', days: '5', slotsField: 'available_slots',
      }, 1720, 160),
      n('date_menu', 'action', 'action.interactive_menu', {
        ...
        slotsField: 'available_slots', selectionField: 'selected_date',
      }, 1960, 160),
      ...
      n('time_menu', 'action', 'action.interactive_menu', {
        ...
        slotsField: 'available_slots', dateField: 'selected_date', selectionField: 'selected_booking_key',
      }, 2440, 160),
      n('wait_time', 'logic', 'logic.wait_for_reply', { timeoutMinutes: '1440' }, 2680, 160),
      n('revalidate_1', 'action', 'action.revalidate_slot', {
        doctorIdField: 'doctor_id', serviceIdField: 'service_id', timezoneField: 'clinic_timezone',
        bookingKeyField: 'selected_booking_key', days: '5', slotsField: 'available_slots',
      }, 2920, 160),
      n('confirm_menu', 'action', 'action.interactive_menu', {
        menuType: 'confirm', title: 'Confirm booking', body: 'Please confirm this appointment.', selectionField: 'booking_confirmation',
      }, 3160, 160),
      ...
      n('book_1', 'action', 'action.create_or_reschedule_booking', {
        mode: 'create', doctorIdField: 'doctor_id', serviceIdField: 'service_id', dateField: 'preferred_date', timeField: 'preferred_time',
      }, 3880, 100),
