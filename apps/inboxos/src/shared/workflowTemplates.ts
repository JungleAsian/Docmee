...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    edges: [
      ...
      e('doctor_menu', 'wait_doctor', 'selected'), e('wait_doctor', 'service_menu'),
      e('service_menu', 'wait_service', 'selected'), e('wait_service', 'slots_1'),
      e('slots_1', 'date_menu'), e('date_menu', 'wait_date', 'selected'), e('wait_date', 'time_menu'),
      e('time_menu', 'wait_time', 'selected'), e('wait_time', 'revalidate_1'), e('revalidate_1', 'confirm_menu'),
      e('confirm_menu', 'wait_confirm', 'selected'), e('wait_confirm', 'confirmed'),
