    ...
    <div className="clinic-page clinic-page-md space-y-6">
      ...
      {query.isLoading ? (
        ...
        <ClinicDetailSaveProvider>
          ...
          {/* Facebook (Messenger), CRM (Google Sheets), and Instagram Direct
              configuration now live in Channels & Integration (single source of
              truth for connections). */}
          <ChannelsMovedNotice />
