...
def main():
    ...
    print(f"  phases={len(phase_model)} gates={data['headline']['gates_total']} "
          f"actions={len(actions)} security={len(security)} risks={len(risks)} "
          f"decisions={decisions_total} gaps={data['headline']['gaps_total']}")
